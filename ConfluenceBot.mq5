//+------------------------------------------------------------------+
//|                                              ConfluenceBot.mq5   |
//|                      Converted from Python MT5 confluence bot    |
//+------------------------------------------------------------------+
...
input int    InpEntryScoreThreshold     = 20;      // UBAH: Turunkan dari 70 ke 50 agar lebih sering entry
...
void ProcessSymbol(const string symbol, const int idx)
{
   ...
   if(signal > 0)
   {
      sl = entry - (actual_sl_distance*11); // Gunakan actual_sl_distance
      tp = entry + actual_sl_distance * 4;
   }
   else
   {
      sl = entry + (actual_sl_distance*11); // Gunakan actual_sl_distance
