...
input double InpRewardAmount = 3;  // Target Profit per trade dalam USD ($)
...
void OnTick()
{
   ...
   if(is_bullish_trend)
   {
      bool m5_buy_signal = (m5_rsi > 50) && (ma20_m5 > ma50_m5);
   ...
   if(is_bearish_trend)
   {
      bool m5_sell_signal = (m5_rsi < 50) && (ma20_m5 < ma50_m5);
