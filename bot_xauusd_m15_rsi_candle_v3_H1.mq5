...
input int    InpSL_Points   = 1600;       // Stop Loss dalam Poin
input int    InpTP_Points   = 2500;       // Take Profit dalam Poin
...
void OnTick()
{
   ...
   double open_price = iOpen(_Symbol, PERIOD_H1, 0);
   double low_price = iLow(_Symbol, PERIOD_H1, 0);
   double high_price = iHigh(_Symbol, PERIOD_H1, 0);
   ...
   double threshold = 300 * point_val; 
