...
input double InpRiskAmount = 20.0;    // Risiko per trade dalam USD ($)
input double InpRewardAmount = 30.0;  // Target Profit per trade dalam USD ($)
...
void OnTick()
{
   ...
   if(h4_rsi > 53 && h1_rsi > 53 && m15_rsi > 53 && m5_rsi > 53 &&
      ma20_m5 > ma50_m5 && ma20_m15 > ma50_m15 && ma20_h1 > ma50_h1 &&
      macd_m5_val > 0 && macd_m15_val > 0 && macd_h1_val > 0)
   {
      is_bullish_trend = true;
   }

   if(h4_rsi < 47 && h1_rsi < 47 && m15_rsi < 47 && m5_rsi < 47 &&
      ma20_m5 < ma50_m5 && ma20_m15 < ma50_m15 && ma20_h1 < ma50_h1 &&
      macd_m5_val < 0 && macd_m15_val < 0 && macd_h1_val < 0)
   {
   ...
   if(is_bullish_trend)
   {
      bool m5_buy_signal = (m5_rsi > 50 || m5_rsi<30) && (ma20_m5 > ma50_m5) && (macd_m5_val > 0);
   ...
   if(is_bearish_trend)
   {
      bool m5_sell_signal = (m5_rsi < 50 || m5_rsi>70) && (ma20_m5 < ma50_m5) && (macd_m5_val < 0);
